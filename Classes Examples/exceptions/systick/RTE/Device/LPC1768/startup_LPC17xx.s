...
Reset_Handler   PROC
				...
				;first STOP the timer before writing on the bits so the timer does not generated interrupts if the timer actually reaches the new values set (unlucky case)
...
timerLoop		add r5, r5, #1
				...
				;WE exited from the timerLoop loop and we execute b . endlessly and the timer contines going because it has not been switched off
                b .
                ENDP
