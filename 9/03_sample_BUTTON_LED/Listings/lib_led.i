...
void LED_init(void) {
 ...
 //((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) ) is struct
 ...
 //I want ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )
 //in LPC17xx.h we see (0x2009C000UL), so I add this to an ogffset to have GPIO2. It's all already done in the header
